...
public:
    ...
    void draw(int x, int y, GLuint substitute, GLint u_texture_unit_location, GLint mvp_matrix_location) const;
    void setViewModelMatrix(const QPointF &viewOffset, double viewZoomFactor, int viewWidth, int viewHeight);
